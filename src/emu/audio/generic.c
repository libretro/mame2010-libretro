...
static INLINE void latch_w(const address_space *space, int which, UINT16 value)
{
...
static INLINE UINT16 latch_r(const address_space *space, int which)
{
...
static INLINE void latch_clear(const address_space *space, int which)
{
	generic_audio_private *state = space->machine->generic_audio_data;
