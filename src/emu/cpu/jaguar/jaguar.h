...
extern void jaguargpu_ctrl_w(running_device *device, offs_t offset, uint32_t data, uint32_t mem_mask);
extern uint32_t jaguargpu_ctrl_r(running_device *device, offs_t offset);

DECLARE_LEGACY_CPU_DEVICE(JAGUARDSP, jaguardsp);
extern void jaguardsp_ctrl_w(running_device *device, offs_t offset, uint32_t data, uint32_t mem_mask);
extern uint32_t jaguardsp_ctrl_r(running_device *device, offs_t offset);
