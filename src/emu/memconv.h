...
INLINE uint16_t read16be_with_read8_handler(read8_space_func handler, const address_space *space, offs_t offset, uint16_t mem_mask)
{
	uint16_t result = 0;
	if (ACCESSING_BITS_8_15)
		result |= ((uint16_t)(*handler)(space, offset * 2 + 0)) << 8;
	if (ACCESSING_BITS_0_7)
		result |= ((uint16_t)(*handler)(space, offset * 2 + 1)) << 0;
	return result;
}


INLINE void write16be_with_write8_handler(write8_space_func handler, const address_space *space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (ACCESSING_BITS_8_15)
...
INLINE uint16_t read16le_with_read8_handler(read8_space_func handler, const address_space *space, offs_t offset, uint16_t mem_mask)
{
	uint16_t result = 0;
	if (ACCESSING_BITS_0_7)
		result |= ((uint16_t) (*handler)(space, offset * 2 + 0)) << 0;
	if (ACCESSING_BITS_8_15)
		result |= ((uint16_t) (*handler)(space, offset * 2 + 1)) << 8;
	return result;
}


INLINE void write16le_with_write8_handler(write8_space_func handler, const address_space *space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (ACCESSING_BITS_0_7)
...
INLINE uint32_t read32be_with_read8_handler(read8_space_func handler, const address_space *space, offs_t offset, uint32_t mem_mask)
{
	uint32_t result = 0;
...
INLINE void write32be_with_write8_handler(write8_space_func handler, const address_space *space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (ACCESSING_BITS_16_31)
...
INLINE uint32_t read32le_with_read8_handler(read8_space_func handler, const address_space *space, offs_t offset, uint32_t mem_mask)
{
	uint32_t result = 0;
	if (ACCESSING_BITS_0_15)
...
INLINE void write32le_with_write8_handler(write8_space_func handler, const address_space *space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (ACCESSING_BITS_0_15)
...
INLINE uint32_t read32be_with_16be_handler(read16_space_func handler, const address_space *space, offs_t offset, uint32_t mem_mask)
{
	uint32_t result = 0;
	if (ACCESSING_BITS_16_31)
...
INLINE void write32be_with_16be_handler(write16_space_func handler, const address_space *space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (ACCESSING_BITS_16_31)
...
INLINE uint32_t read32le_with_16le_handler(read16_space_func handler, const address_space *space, offs_t offset, uint32_t mem_mask)
{
	uint32_t result = 0;
	if (ACCESSING_BITS_0_15)
...
INLINE void write32le_with_16le_handler(write16_space_func handler, const address_space *space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (ACCESSING_BITS_0_15)
...
INLINE uint32_t read32be_with_16le_handler(read16_space_func handler, const address_space *space, offs_t offset, uint32_t mem_mask)
{
	uint32_t result = 0;
...
INLINE void write32be_with_16le_handler(write16_space_func handler, const address_space *space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
INLINE uint32_t read32le_with_16be_handler(read16_space_func handler, const address_space *space, offs_t offset, uint32_t mem_mask)
{
	uint32_t result = 0;
	mem_mask = FLIPENDIAN_INT32(mem_mask);
...
INLINE void write32le_with_16be_handler(write16_space_func handler, const address_space *space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	data = FLIPENDIAN_INT32(data);
	mem_mask = FLIPENDIAN_INT32(mem_mask);
...
INLINE uint64_t read64be_with_read8_handler(read8_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)read32be_with_read8_handler(handler, space, offset * 2 + 0, mem_mask >> 32) << 32;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)read32be_with_read8_handler(handler, space, offset * 2 + 1, mem_mask) << 0;
	return result;
}


INLINE void write64be_with_write8_handler(write8_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
...
INLINE uint64_t read64le_with_read8_handler(read8_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)read32le_with_read8_handler(handler, space, offset * 2 + 0, mem_mask >> 0) << 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)read32le_with_read8_handler(handler, space, offset * 2 + 1, mem_mask >> 32) << 32;
	return result;
}


INLINE void write64le_with_write8_handler(write8_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_0_31)
...
INLINE uint32_t read64be_with_16be_handler(read16_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)read32be_with_16be_handler(handler, space, offset * 2 + 0, mem_mask >> 32) << 32;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)read32be_with_16be_handler(handler, space, offset * 2 + 1, mem_mask >> 0) << 0;
	return result;
}


INLINE void write64be_with_16be_handler(write16_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
...
INLINE uint32_t read64le_with_16le_handler(read16_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)read32le_with_16le_handler(handler, space, offset * 2 + 0, mem_mask >> 0) << 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)read32le_with_16le_handler(handler, space, offset * 2 + 1, mem_mask >> 32) << 32;
	return result;
}


INLINE void write64le_with_16le_handler(write16_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_0_31)
...
INLINE uint32_t read64be_with_16le_handler(read16_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)read32be_with_16le_handler(handler, space, offset * 2 + 0, mem_mask >> 32) << 32;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)read32be_with_16le_handler(handler, space, offset * 2 + 1, mem_mask >> 0) << 0;
	return result;
}


INLINE void write64be_with_16le_handler(write16_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
...
INLINE uint32_t read64le_with_16be_handler(read16_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)read32le_with_16be_handler(handler, space, offset * 2 + 0, mem_mask >> 0) << 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)read32le_with_16be_handler(handler, space, offset * 2 + 1, mem_mask >> 32) << 32;
	return result;
}


INLINE void write64le_with_16be_handler(write16_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_0_31)
...
INLINE uint64_t read64be_with_32be_handler(read32_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_32_63)
		result |= (uint64_t)(*handler)(space, offset * 2 + 0, mem_mask >> 32) << 32;
	if (ACCESSING_BITS_0_31)
		result |= (uint64_t)(*handler)(space, offset * 2 + 1, mem_mask >> 0) << 0;
	return result;
}


INLINE void write64be_with_32be_handler(write32_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
...
INLINE uint64_t read64le_with_32le_handler(read32_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result = 0;
	if (ACCESSING_BITS_0_31)
...
INLINE void write64le_with_32le_handler(write32_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_0_31)
...
INLINE uint64_t read64be_with_32le_handler(read32_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result;
...
INLINE void write64be_with_32le_handler(write32_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
...
INLINE uint64_t read64le_with_32be_handler(read32_space_func handler, const address_space *space, offs_t offset, uint64_t mem_mask)
{
	uint64_t result;
	mem_mask = FLIPENDIAN_INT64(mem_mask);
...
INLINE void write64le_with_32be_handler(write32_space_func handler, const address_space *space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	data = FLIPENDIAN_INT64(data);
	mem_mask = FLIPENDIAN_INT64(mem_mask);
