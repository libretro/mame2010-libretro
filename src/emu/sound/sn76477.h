...
void sn76477_enable_w(running_device *device, uint32_t data);		/* active LO, 0 = enabled, 1 = disabled */
...
void sn76477_vco_w(running_device *device, uint32_t data);			/* 0 = external, 1 = controlled by SLF */
void sn76477_noise_clock_w(running_device *device, uint32_t data);  /* noise clock write, if noise_clock_res = 0 */
