...
struct x76f041_chip
{
	...
	uint8_t *configuration_password;
	uint8_t *configuration_registers;
	uint8_t *data;
};
...
void x76f041_init( running_machine *machine, int chip, uint8_t *data )
{
	int offset;
...
static uint8_t *x76f041_password( struct x76f041_chip *c )
{
