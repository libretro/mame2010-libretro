...
{
	LOG(("PC %08X: TMP68301_timer_r (%08X)\n", cpu_get_pc(space->cpu), (0xfffe00 + (offset * 2))));
...
{
	LOG(("PC %08X: TMP68301_timer_w (%08X = %04X)\n", cpu_get_pc(space->cpu), (0xfffe00 + (offset * 2)), data));
