...
uint32_t	*BFM_BD1_get_segments(int id);			// get current segments displayed
uint32_t  *BFM_BD1_set_outputs(int id);			// convert segments to standard for display
uint32_t  *BFM_BD1_get_outputs(int id);			// get converted segments
