...
VIDEO_START( suna16 )
{
	machine->generic.paletteram.u16 = auto_alloc_array(machine, uint16_t, machine->total_colors());
}
...
static void draw_sprites(running_machine *machine, bitmap_t *bitmap, const rectangle *cliprect, uint16_t *sprites, int gfx)
{
	int offs;
