...
static INPUT_PORTS_START( jpark )
	...
	PORT_START("ANALOG1")
	PORT_BIT( 0xff, 0x9c, IPT_AD_STICK_X ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5)

	PORT_START("ANALOG2")
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_Y ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5)

	PORT_START("ANALOG3")
	PORT_BIT( 0xff, 0x63, IPT_AD_STICK_X ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_PLAYER(2)
