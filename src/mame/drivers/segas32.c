...
static INPUT_PORTS_START( jpark )
	...
	PORT_START("LIGHT0_X")
	PORT_BIT( 0xff, 0x9c, IPT_LIGHTGUN_X ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_MINMAX(0x40,0xc0)

	PORT_START("LIGHT0_Y")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_Y ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_MINMAX(0x40,0xc0)

	PORT_START("LIGHT1_X")
	PORT_BIT( 0xff, 0x63, IPT_LIGHTGUN_X ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_PLAYER(2) PORT_MINMAX(0x40,0xc0)

	PORT_START("LIGHT1_Y")
	PORT_BIT( 0xff, 0x80, IPT_LIGHTGUN_Y ) PORT_SENSITIVITY(50) PORT_KEYDELTA(5) PORT_PLAYER(2) PORT_MINMAX(0x40,0xc0)
INPUT_PORTS_END
